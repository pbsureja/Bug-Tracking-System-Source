...
<body>
	<div id="new">
		...
		%>
		<form action="TaskInsertServlet" name="Task" method="post" id="form">
			<table align="center">
				...
				<tr>
					...
					<td><input type="text"  class="validate[required,custom[date]] text-input datepicker" name="actual_end_date" id="actual_end_date"
