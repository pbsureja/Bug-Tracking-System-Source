...
<body>
 <div id="new">
<hr><center><h1>Project Technology Insert Form</h1></center><hr>
	<form action="ProjectTechnologyInsertServlet" id="form"
		name="projecttechnologyinsertpage" method="post">
		<table align="center">

			<tr>
				<td>Technology Description:
				<td><input type="text" name="Technology_description"
				class="validate[required,maxSize[25]] text-input"	id="Technology_description"> ${Technology_description}
			</tr>
