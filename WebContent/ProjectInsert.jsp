...
<title>Project Insert Page</title>
<link rel="stylesheet"
...
<body>
	<div id="new">
		...
		%>
		<form action="ProjectInsertServlet" id="form" name="Project"
			method="post">
			<table align="center">
				...
				<tr>
					<td>Client</td>
					<td><select name="client_id" id="client_id" class="validate[required]">
				...
				<tr>
					...
					<td><input type="text" name="actual_end_date" id="actual_end_date"
 						class="validate[required,custom[date]] text-input datepicker"
						value="${bean.actual_end_date}">${actual_end_date}
				...
				<tr>
					<td>Modified By</td>
					<td><select name="modified_by" id="modified_by" class="validate[required]">
