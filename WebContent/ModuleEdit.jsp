...
<body>
	<div id="new">
		...
		%>
		<form action="ModuleUpdateServlet" id="form" name="Module"
			method="post">
			<input type="hidden" name="module_id" value="${bean.module_id}">
			...
			<%
				...
				<tr>
					<td>Project</td>
					<td><select name="project_id" id="project_id" class="validate[required]">
